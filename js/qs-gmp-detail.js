 ...
 *   qmsFocus      质量管理关注要点 [{area, points:[...]}]，按 ICH Q10 质量体系要素分域（质量风险管理 / 物料与供应商 / 工艺验证与CPV / 变更控制 / 偏差与CAPA / 数据完整性 / 稳定性与监测 / 污染控制策略CCS / 质量回顾）
...
(function () {
  ...
  var QS_GMP_DETAIL = {
    ...
    sterile: {
      ...
      qmsFocus: [
        { area: '质量风险管理（QRM）', points: ['以无菌保证水平（SAL ≤ 10⁻⁶）为核心风险点，任何污染事件须 FMEA 评估并制定缓解措施。', '环境监控（EM）超标、悬浮粒子预警须触发趋势性风险评估，纳入年度产品质量回顾。'] },
        { area: '无菌工艺验证管理', points: ['介质模拟灌装按每生产线每班次至少每半年一次、连续 3 批成功确认；最差条件与干预清单纳入变更控制。', '无菌工艺、设备、厂房发生变更后须重新开展模拟灌装验证。'] },
        { area: '环境监控（EM）体系', points: ['A/B/C/D 级动态监测悬浮粒子与浮游菌、沉降菌、表面碟、人员手套；设警戒限 / 纠偏限。', '定期趋势分析，超标须启动偏差调查并评估对相邻批次的影响。'] },
        { area: '变更控制', points: ['无菌相关变更（工艺、设备、厂房、无菌工艺、滤器）须评估对无菌保证的影响并触发再验证 / 再确认。', '除菌过滤器的验证状态（完整性、相容性）纳入变更与年度回顾。'] },
        { area: '偏差与 CAPA', points: ['无菌检查阳性、EM 超标、人员干预异常均须按最高级别调查；CAPA 须确认有效性。', '污染根因调查延伸至 HVAC、清洁、人员操作与物料。'] },
        { area: '数据完整性（DI）', points: ['电子批记录、HVAC / EM 自动采集系统须防篡改并保留审计追踪。', '手动记录（如无菌更衣、干预）须即时、完整、不可改写。'] },
        { area: '污染控制策略（CCS）', points: ['按 GMP 附录1 制定覆盖厂房、工艺、人员、物料、设备、清洁的全要素污染控制策略。', 'CCS 须与质量风险管理和年度回顾联动，持续识别与降低污染风险。'] },
        { area: '质量回顾', points: ['年度产品质量回顾须包含无菌数据、模拟灌装结果、CCI 与 EM 趋势、偏差 / CAPA 汇总。', '关键趋势（如浮游菌上升）须触发 CCS 修订与再确认。'] }
      ]
    },
    ...
    api: {
      ...
      qmsFocus: [
        { area: '质量风险管理（QRM）', points: ['建立杂质谱风险评估（有关物质、降解杂质、元素杂质、残留溶剂）；基因毒性杂质按 ICH M7 设定控制策略。', '高活性 / 高致敏性品种须开展交叉污染与职业暴露风险评估（PDE / HBEL）。'] },
        { area: 'CQA / CPP 管理', points: ['通过风险评估识别 CQA 与 CPP，建立设计空间与控制策略；工艺开发知识纳入知识管理。', '晶型、粒度分布等多晶型相关属性对下游口服制剂的影响须专项评估。'] },
        { area: '工艺验证与持续工艺确认（CPV）', points: ['商业化前完成至少连续 3 批成功的前验证；上市后通过 CPV 持续监测 CPP / CQA 漂移。', '工艺变更后须重新验证并评估对货架期与注册标准的影响。'] },
        { area: '起始物料与供应商管理', points: ['起始物料须论证合理性并确立控制策略；供应商经审计并签质量协议。', '供应链（尤其关键起始物料、催化剂）变更须评估对 CQA 的影响。'] },
        { area: '变更控制', points: ['工艺参数、生产场地、物料供应商变更须可比性研究与再验证。', '合成路线 / 关键工艺步骤变更按重大变更管理并申报。'] },
        { area: '偏差与 CAPA', points: ['杂质超限、收率异常、晶型偏离均须调查；CAPA 须验证有效性。', '反复出现的工艺漂移须升级为根本原因分析。'] },
        { area: '数据完整性（DI）', points: ['批记录与色谱（HPLC / GC）数据须完整、一致并保留审计追踪。', '工艺参数（温度、pH、时间）自动采集防篡改。'] },
        { area: '稳定性与持续监测', points: ['长期 / 加速稳定性考察支撑货架期；中控策略覆盖关键步骤。', '留样观察与杂质趋势分析纳入年度回顾。'] }
      ]
    },
    ...
    radiopharm: {
      ...
      qmsFocus: [
        { area: '质量风险管理（QRM）', points: ['辐射安全与时间窗（半衰期）为首要风险；活度 / 核素混淆须 FMEA 评估并双人核对。', '短半衰期品种（如 ¹⁸F）须评估检验与放行时间窗风险。'] },
        { area: '时间窗管理', points: ['生产、分装、检验、使用须在衰变允许时间内完成；QC 可并行或豁免的须有书面论证。', '超出校准时间窗的产品不得放行，须按放射性废物处置。'] },
        { area: '辐射防护体系', points: ['工作人员资质、个人剂量监测、表面污染监测纳入日常；生产场所辐射分区（控制区 / 监督区）。', '屏蔽热室与远程操作降低暴露，定期去污监测。'] },
        { area: '变更控制', points: ['核素来源、标记工艺、分装设备变更须评估对放射性纯度 / 放化纯的影响。', '时间窗与检验策略（并行 / 豁免）变更须验证。'] },
        { area: '偏差与 CAPA', points: ['活度偏差、放化纯不合格、表面污染超标均须调查；CAPA 须确认。', '核素混淆事件须按严重偏差处理并追溯全部相关分装。'] },
        { area: '物料（前体 / 同位素）管理', points: ['标记前体质量与供应商受控；放射性核素来源合法可追溯。', '非放射性物料同样须符合相应质量标准。'] },
        { area: '数据完整性（DI）', points: ['活度计定期校准，活度数据自动采集并保留审计追踪。', '分装记录与报废记录完整可追溯。'] },
        { area: '质量回顾', points: ['年度回顾含活度、放化纯、放射性核素纯度趋势与表面污染监测。', '时间窗超限与偏差汇总纳入趋势分析。'] }
      ]
    },
    ...
    oral_solid: {
      ...
      qmsFocus: [
        { area: '质量风险管理（QRM）', points: ['粉尘交叉污染须基于 PDE / HBEL 评估并设定可接受残留；含量均匀度与溶出为关键质量风险。', '外观相似品种混淆风险须专项评估。'] },
        { area: '物料与供应商管理', points: ['API 来源、包衣材料、辅料（尤其高活 / 激素）须供应商审计与质量协议。', '物料变更（如供应商、级别）须评估对溶出与含量均匀度的影响。'] },
        { area: '工艺验证与持续工艺确认（CPV）', points: ['混合均匀度、含量均匀度、溶出度验证；上市后 CPV 监测关键属性趋势。', '润滑剂加入顺序 / 混合时间等参数须验证并受控。'] },
        { area: '变更控制', points: ['处方、工艺、设备、包装变更须可比性研究与再验证（尤其是溶出相关）。', '多产品共线清洁限度变更须重新评估。'] },
        { area: '偏差与 CAPA', points: ['含量均匀度不合格、溶出异常、外观混淆均须调查；CAPA 须确认。', '市场投诉（裂片、溶出偏低）须回溯工艺参数。'] },
        { area: '交叉污染控制（CCS）', points: ['清洁验证限度基于 PDE / HBEL；粉尘捕集与阶段性生产降低残留。', '高活 / 激素 / 细胞毒口服制剂须专用或强隔离。'] },
        { area: '数据完整性（DI）', points: ['在线称量、压片力、包衣参数自动采集并保留审计追踪。', '手工混合时间记录须即时完整。'] },
        { area: '质量回顾', points: ['年度回顾含溶出趋势、含量均匀度、市场投诉与稳定性数据。', '关键趋势（溶出下降）须触发工艺再确认。'] }
      ]
    },
    ...
    biological: {
      ...
      qmsFocus: [
        { area: '质量风险管理（QRM）', points: ['病毒安全、细胞系稳定性、聚体 / 片段与翻译后修饰为关键风险，须 FMEA 与持续监控。', '一次性系统（SUS）浸出物 / 可提取物须风险评估。'] },
        { area: '细胞库 / 种子批管理', points: ['MCB / WCB 全面检定、专帐保管与追溯；贮存条件监控与稳定性（如适用）评估。', '防止不同细胞系混淆与污染，建立鉴别与限传代管理。'] },
        { area: '病毒清除验证管理', points: ['灭活与去除步骤须验证并累计对数下降因子（LRV）；不同机制双保险。', '工艺变更影响病毒清除时须重新验证。'] },
        { area: '工艺验证与持续工艺确认（CPV）', points: ['培养 / 纯化 CPP 验证与批间一致性监测；一次性系统完整性 / 兼容性验证。', '聚集体、宿主细胞蛋白 / DNA 等 CQA 趋势纳入 CPV。'] },
        { area: '变更控制', points: ['细胞库、培养基、纯化工艺变更须可比性与再验证（包括效价与杂质）。', '一次性系统供应商 / 规格变更须相容性与浸出物再评估。'] },
        { area: '偏差与 CAPA', points: ['效价偏差、聚体升高、内毒素超标须调查；CAPA 须确认有效性。', '污染（支原体 / 病毒）须最高级别调查并评估相邻批次。'] },
        { area: '数据完整性（DI）', points: ['生物反应器、层析系统数据自动采集并保留审计追踪。', '细胞库操作与检定记录完整可追溯。'] },
        { area: '质量回顾', points: ['年度回顾含效价、杂质、聚体、病毒安全趋势与批签发。', '关键 CQA 漂移须触发工艺再确认与 CCS 修订。'] }
      ]
    },
    ...
    blood: {
      ...
      qmsFocus: [
        { area: '质量风险管理（QRM）', points: ['血源传播病毒（HBV / HCV / HIV）为最高风险；不同批血浆混批须专项评估。', '组分分离过程交叉污染须风险评估。'] },
        { area: '血浆检疫体系', points: ['供浆员筛查 + 检疫期（≥90 天）复检合格方可投料；批血浆全程追溯。', '单采血浆站须质量协议与定期审计。'] },
        { area: '病毒灭活验证', points: ['每步添加至少两种不同机制病毒去除 / 灭活并验证 LRV；持续保持验证状态。', '灭活工艺变更须重新验证。'] },
        { area: '物料与血浆管理', points: ['原料血浆冷链与温度监控；组分追溯。', '关键试剂（如 S/D 试剂）供应商受控。'] },
        { area: '变更控制', points: ['组分分离工艺、病毒灭活步骤、规格变更须再验证与申报。', '生产场地变更须可比性研究。'] },
        { area: '偏差与 CAPA', points: ['病毒检测异常、内毒素超标、混批风险须最高级别调查。', 'CAPA 须确认并覆盖相关批血浆。'] },
        { area: '数据完整性（DI）', points: ['血浆批追溯、批签发数据完整并保留审计追踪。', '检疫期复检结果系统比对防漏检。'] },
        { area: '质量回顾', points: ['年度回顾含批签发、病毒安全、稳定性与偏差趋势。', '检疫期复检异常须触发供浆员管理升级。'] }
      ]
    },
    ...
    vaccine: {
      ...
      qmsFocus: [
        { area: '质量风险管理（QRM）', points: ['灭活不完全、活毒扩散、种子批污染为关键风险；须 FMEA 与专项控制。', '佐剂相关安全性（结节、过敏）须关注。'] },
        { area: '种子批管理', points: ['主 / 工作种子批全面检定、专帐保管与追溯；防污染与毒力返祖。', '种子批稳定性与限代次管理。'] },
        { area: '灭活验证体系', points: ['灭活须证明完全灭活（无活病毒 / 活菌残留）并设安全余量；每批灭活监测。', '灭活工艺变更须重新验证。'] },
        { area: '工艺验证与持续工艺确认（CPV）', points: ['培养滴度 / 菌体密度、佐剂配制均匀性 CPP 验证与监测。', '抗原含量与效价趋势纳入 CPV。'] },
        { area: '变更控制', points: ['毒种、工艺、佐剂、生产场地变更须可比性与再验证（含免疫原性）。', '活疫苗与灭活疫苗共线须严格物理隔离论证。'] },
        { area: '偏差与 CAPA', points: ['效价偏差、污染、灭活不完全须最高级别调查；CAPA 确认。', '种子批异常须评估全部相关批次。'] },
        { area: '数据完整性（DI）', points: ['发酵 / 纯化 / 分装数据自动采集并保留审计追踪。', '批签发检验数据完整可追溯。'] },
        { area: '质量回顾', points: ['年度回顾含效价、安全性、批签发与稳定性趋势。', '关键趋势须触发工艺再确认。'] }
      ]
    },
    ...
    cell_gene: {
      ...
      qmsFocus: [
        { area: '质量风险管理（QRM）', points: ['患者特异性混淆（不可逆）、病毒载体扩散、严格时限为最高风险；须 FMEA 与最高级别控制。', '可复制型病毒（RCL）风险须专项评估与监测。'] },
        { area: '身份核对体系', points: ['唯一标识 + 双人核对贯穿采集、修饰、扩增、回输全链，防止不同患者细胞混淆。', '身份核对失误须按严重事件处置并阻断回输。'] },
        { area: '供者材料管理', points: ['供者筛查（传染病指标）；自体 / 异体全程唯一标识与追溯。', '供者材料冷链与时限受控。'] },
        { area: '密闭系统与无菌工艺', points: ['一次性密闭系统减少开放操作；无菌工艺验证，活细胞不可终端灭菌。', '时限控制（超时影响活性与合规）须监控预警。'] },
        { area: '变更控制', points: ['载体、工艺、转运条件变更须可比性；患者特异性制品重做成本高须谨慎。', '基因修饰载体制备变更须 RCL 再评估。'] },
        { area: '偏差与 CAPA', points: ['身份核对异常、污染、超时应最高级别调查（不可逆须最严）。', 'CAPA 须确认并覆盖相关患者批次。'] },
        { area: '数据完整性（DI）', points: ['全过程电子追溯、冷链温度自动采集并保留审计追踪。', '基因修饰载体拷贝数等关键数据完整。'] },
        { area: '质量回顾', points: ['按患者 / 批次回顾活性、安全性与时限符合性。', 'RCL 监测与载体相关不良事件趋势分析。'] }
      ]
    },
    ...
    tcm_prep: {
      ...
      qmsFocus: [
        { area: '质量风险管理（QRM）', points: ['农残、重金属、真菌毒素、毒性药材与易混淆基原为关键风险，须 FMEA 与批批控制。', '挥发性成分损失须专项评估。'] },
        { area: '药材与供应商管理', points: ['基原鉴别、产地与供应商审计；毒性药材专区与专用设备。', '药材变更（基原 / 产地）须评估对 CQA 的影响。'] },
        { area: '炮制与提取管理', points: ['净制、切制、炮炙按规范；提取参数（温度 / 时间 / 溶媒比）CPP 验证。', '挥发性成分（挥发油）须在提取阶段收集。'] },
        { area: '工艺验证与持续工艺确认（CPV）', points: ['提取收率、成型与干燥参数验证；关键属性趋势纳入 CPV。', '浸膏相对密度等中控参数受控。'] },
        { area: '变更控制', points: ['处方、工艺、药材基原变更须再验证与申报。', '炮制辅料（酒 / 醋 / 盐 / 蜜）变更须评估。'] },
        { area: '偏差与 CAPA', points: ['农残 / 重金属超标、混淆、毒性控制不足须调查；CAPA 确认。', '提取收率异常须根因分析。'] },
        { area: '数据完整性（DI）', points: ['提取 / 干燥参数自动采集并保留审计追踪。', '药材基原与批号记录完整可追溯。'] },
        { area: '质量回顾', points: ['年度回顾含农残、重金属、微生物、真菌毒素趋势。', '市场反馈（有效性 / 安全性）纳入趋势分析。'] }
      ]
    },
    ...
    tcm_pieces: {
      ...
      qmsFocus: [
        { area: '质量风险管理（QRM）', points: ['毒性饮片减毒、硫熏残留、混淆 / 伪品为关键风险，须 FMEA 与专项控制。', '易霉变品种黄曲霉毒素风险须关注。'] },
        { area: '基原与性状鉴别', points: ['性状、显微、薄层鉴别防伪品与混淆品；基原鉴别贯穿入库。', '同名异物、易混淆药材须建立防混淆清单。'] },
        { area: '炮炙管理', points: ['毒性饮片（附子、生川乌等）炮炙减毒并验证；辅料（酒 / 醋 / 盐 / 蜜）质控。', '火候、炮制程度须受控并记录。'] },
        { area: '仓储养护', points: ['防虫蛀、霉变、泛油；分类存放与温湿度监控。', '毒性饮片独立贮存并双人双锁。'] },
        { area: '变更控制', points: ['炮制工艺、产地 / 基地变更须再确认。', '硫熏工艺变更须重新评估二氧化硫残留。'] },
        { area: '偏差与 CAPA', points: ['二氧化硫、黄曲霉毒素、重金属超标须调查；CAPA 确认。', '混淆 / 伪品流入须最高级别调查并追溯。'] },
        { area: '数据完整性（DI）', points: ['追溯码、检验数据完整并保留审计追踪。', '毒性饮片称量与炮炙记录双人复核。'] },
        { area: '质量回顾', points: ['年度回顾含二氧化硫、黄曲霉毒素、重金属与微生物趋势。', '易混淆品种鉴别异常须触发供应商管理升级。'] }
      ]
    },
    ...
    medical_gas: {
      ...
      qmsFocus: [
        { area: '质量风险管理（QRM）', points: ['气体混杂（成分错误）为最高风险；水分 / 油污染与充装安全须专项评估。', '不同气体同系统混入须 FMEA 与物理隔离。'] },
        { area: '生产系统隔离', points: ['不同医用气体管道、储罐、气瓶系统相互独立，防止成分错误。', '共用系统切换须清洗置换验证。'] },
        { area: '充装管理', points: ['气瓶清洗、置换与干燥；按充装系数 / 压力充装防超装混装。', '充装记录完整并双人复核。'] },
        { area: '在线质量监测', points: ['水分、CO、CO₂、油分在线监测；逐瓶 / 逐批检验纯度与杂质。', '在线监测报警须纳入偏差管理。'] },
        { area: '变更控制', points: ['气源、系统、工艺变更须评估对纯度的影响并再确认。', '气瓶 / 充装设备变更须清洗置换验证。'] },
        { area: '偏差与 CAPA', points: ['纯度不合格、混入、超装须最高级别调查；CAPA 确认。', '混入事件须追溯全部相关气瓶。'] },
        { area: '数据完整性（DI）', points: ['在线监测自动采集并保留审计追踪；充装参数防篡改。', '气瓶标识与追溯码完整。'] },
        { area: '质量回顾', points: ['年度回顾含纯度、杂质趋势与充装安全。', '在线监测报警汇总纳入趋势分析。'] }
      ]
    }
  };
