...
(function () {
  ...
  var MODAL_HTML = [
    ...
    '      <p class="qa9-modal-tip">已内置 37 家免费/低成本服务商（含 OpenRouter / Hugging Face / Cloudflare / ModelScope / 讯飞星火 / GitHub Models / NVIDIA NIM / Cerebras / DeepInfra / Fireworks AI / Perplexity / 商汤 SenseNova / 华为云 MaaS / AtomGit 等免信用卡免费档），选服务商 + 粘贴 Key 即用；各服务商 Key 独立保存、不重复填写。下方可直接切换内置模型，或点「+ 新增」自定义（任意 OpenAI 兼容）。</p>',
